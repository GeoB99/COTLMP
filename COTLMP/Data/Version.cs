...
{
    /// <summary>
    /// Encapsulates the critical version data of the mod, such as the GUID, name and version of the mod.
    /// The GUID is set to be unique and permanent, DO NOT CHANGE IT!
    /// </summary>
