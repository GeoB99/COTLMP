...
using static COTLMP.Api.Configuration;
...
public class Plugin : BaseUnityPlugin
{
    ...
    private void Awake()
    {
        ...
        bool ToggleMod, SayChat, VoiceChat;
        ...
        /*
         * Load the settings of the mod (or write the defaults) in following
         * order, first the "Toggle Mod" setting.
         */
        SettingData = COTLMP.Api.Configuration.LoadSetting(CONFIGURATION_SECTION.ModSettings,
                                                           "Toggle Mod",
                                                           "Enables or Disables the Multiplayer mod in runtime",
                                                           true);
        if (SettingData == null)
        {
            Logger.LogFatal("Failed to load or set default to the \"Mod Toggle\" setting!");
            Harmony.UnpatchAll();
            return;
        }
        ...
        /* Load the "Game Mode" setting */
        SettingData = COTLMP.Api.Configuration.LoadSetting(CONFIGURATION_SECTION.ServerSettings,
                                                           "Game Mode",
                                                           "The game mode for the multiplayer server. Possible values are: Standard, Boss Fight, Deathmatch, Zombies!",
                                                           "Standard");
        if (SettingData == null)
        {
            Logger.LogFatal("Failed to load or set default to the \"Game Mode\" setting!");
            Harmony.UnpatchAll();
            return;
        }
        ...
        if (SettingData == null)
        {
            Logger.LogFatal("Failed to load or set default to the \"Player Name\" setting!");
            Harmony.UnpatchAll();
            return;
        }
        ...
        if (SettingData == null)
        {
            Logger.LogFatal("Failed to load or set default to the \"Server Name\" setting!");
            Harmony.UnpatchAll();
            return;
        }
        ...
        /* Load the "Max Players In Server" setting */
        SettingData = COTLMP.Api.Configuration.LoadSetting(CONFIGURATION_SECTION.ServerSettings,
                                                           "Max Players",
        ...
        if (SettingData == null)
        {
            Logger.LogFatal("Failed to load or set default to the \"Max Players\" setting!");
            Harmony.UnpatchAll();
            return;
        }
        ...
        /* Load the "Enable Voice Chat" setting */
        SettingData = COTLMP.Api.Configuration.LoadSetting(CONFIGURATION_SECTION.ServerSettings,
                                                           "Toggle Voice Chat",
        ...
        if (SettingData == null)
        {
            Logger.LogFatal("Failed to load or set default to the \"Toggle Voice Chat\" setting!");
            Harmony.UnpatchAll();
            return;
        }
        ...
        /* Load the "Enable Say Chat" setting */
        SettingData = COTLMP.Api.Configuration.LoadSetting(CONFIGURATION_SECTION.ServerSettings,
                                                           "Toggle Say Chat",
                                                           "Enables or Disables say chat in a server",
                                                           true);
        if (SettingData == null)
        {
            Logger.LogFatal("Failed to load or set default to the \"Toggle Say Chat\" setting!");
            Harmony.UnpatchAll();
            return;
        }

        /* Retrieve the setting data from the setting object */
        SayChat = COTLMP.Api.Configuration.GetSettingData<bool>(SettingData);
